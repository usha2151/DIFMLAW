...
import Lawyer_pic from "../../images/lawyer_pic.png";
                ...
                <div className='col-lg-6'>
                    <div className='row ab'>
                        ...
                        <div className='col-lg-6 col-xs-12'>
                           ...
                           <p className='fs-6 laywer_exp fw-bold'>33+ Years in practice</p>
                           <p className='fw-bold mb-2 star fs-5'>*****</p>
                        </div>
                    </div>
                </div>
                <div className='col-lg-6 text-end d-flex justify-content-end gap-2'>
                  <div className='me-4 w-50'><button className='btn btn-primary me-4 w-100 rounded-pill mt-5'>Contact Now</button></div>
                  <div><span className='fw-bold fs-3'><i class="bi bi-bookmark"></i></span><p className='fs-6 save text-center'>save</p></div>
    ...
    <div className="mt-4">
      ...
      ></iframe>
        ...
        <div class="form-outline">
          <input type="search" value='https://www.kreate.com/job-apply-325...' class="form-control ss-2 w-100" /> 
           </div>
